...
class MockRPMBasedOS(object):
    ...
    def create_base_image(self, builder, template, parameters):
        self.log.info('create_base_image() called for MockRPMBasedOS plugin - creating a BaseImage')
        return BaseImage(template)

    def create_target_image(self, builder, target, base_image, parameters):
        self.log.info('create_target_image() called for MockRPMBasedOS plugin - creating a TargetImage')
